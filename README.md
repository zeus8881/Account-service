...
У проєкті realізовано швидкі **зрізові інтеграційні тести (Slice Integration Tests)** для контролерів та веб-інфраструктури через `MockMvc` із підміною бізнес-шару через `@MockBean`. 
